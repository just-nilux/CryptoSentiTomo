...
# Return the number of Search calls remaining in current window ---------------------
...
# Remove Emojis function (might not needed if doing sentiment analysis)-------------
...
# Function Tweet_Search upgraded -----------------------
